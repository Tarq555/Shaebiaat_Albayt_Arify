        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {featuredList.map((dish) => {
            ...
            return (
              ...
              >
                {/* Live Admin Quick Edit Overlay Button */}
                {isAdmin && liveEditMode && (
                  <div className="absolute top-3 start-3 z-30 flex items-center gap-1">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                      ...
                      title={isAr ? 'تعديل الصنف فوراً (اسم، سعر، صورة، وصف)' : 'Quick Edit Dish'}
                    >
                ...
                <div className="relative h-56 sm:h-60 overflow-hidden bg-stone-100">
                  ...
                  <div className={`absolute top-3 ${isAdmin && liveEditMode ? 'start-28' : 'start-3'} end-3 flex items-center justify-between gap-2 z-10`}>
